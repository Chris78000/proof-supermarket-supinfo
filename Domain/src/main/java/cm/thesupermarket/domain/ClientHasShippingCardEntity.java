 ...
 * @author ryank
 */
@Entity(name = "ClientHasShippingCardEntity")
@Table(name = "client_has_shipping_card")
public class ClientHasShippingCardEntity implements Serializable, Persistable<Long> {
