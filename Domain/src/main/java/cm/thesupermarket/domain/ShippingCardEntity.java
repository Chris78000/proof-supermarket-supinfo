 ...
 * @author ryank
 */
@Entity(name = "ShippingCardEntity")
@Table(name = "shipping_card")
public class ShippingCardEntity implements Serializable, Persistable<Long> {
    ...
    @PostPersist
    @PostUpdate
    protected void postPersistAndPostUpdate() {
